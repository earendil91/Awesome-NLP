...
# Training script for English to Greek machine translation training using stacked self-attention encoders (similar to Transformers). It requires a parallel (EN-EL) text. 
